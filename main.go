...
func setInternalRoute(cfg *config.Config, r *touka.Engine) error {
	...
	//r.GET("/", pageCacheHeader(), touka.AdapterStdHandle(http.FileServer(http.FS(pages))))
	//r.GET("/script.js", pageCacheHeader(), touka.AdapterStdHandle(http.FileServer(http.FS(pages))))
	//r.GET("/style.css", pageCacheHeader(), touka.AdapterStdHandle(http.FileServer(http.FS(pages))))
	//r.GET("/bootstrap.min.css", pageCacheHeader(), touka.AdapterStdHandle(http.FileServer(http.FS(assets))))
	//r.GET("/bootstrap.bundle.min.js", pageCacheHeader(), touka.AdapterStdHandle(http.FileServer(http.FS(assets))))
	//r.SetUnMatchFS(http.FS(pages))
